...
export const Hero = () => {
  return (
    <div className="pt-10 md:pt-20 lg:pt-16">
      <Container>
        <p className="bg-gray-300 rounded-xl py-1 px-4 text-center w-fit mx-auto text-xs mb-6">Introducing Aceprep An Interview Preparation Platform</p>
        ...
        <div className="flex items-center gap-6 justify-center">
          <Link href="/register">
            <button className="text-sm text-neutral-200 px-4 py-1.5 bg-foreground dark:bg-background dark:text-neutral-800 rounded-lg active:scale-[0.97] shadow-brand flex items-center cursor-pointer">Start Free
